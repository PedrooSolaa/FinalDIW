      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center mb-6">
          ...
          <div className="flex items-center justify-center">
            <img src={logoPrincipal} alt="Logo" className="h-16 md:h-20 object-contain" />
          </div>
        ...
        {/* Copyright */}
        <div className="mt-6 pt-6 grid grid-cols-1 md:grid-cols-3 items-center gap-4">
          <div className="hidden md:block" />
          <p className="text-xs text-white text-center">copyright</p>
          <div className="flex space-x-3 justify-center md:translate-x-4">
            <a
              href="#"
